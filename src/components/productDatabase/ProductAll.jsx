...
const ProductAll = () => {
  ...
  return (
 <div className="w-full sm:px-6 sm:py-4 sm:bg-white bg-gray-50 p-3 rounded-lg">
  {/* Top Search + Filter */}
  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4 text-black">
    ...
    <input
      ...
      className="w-full sm:w-[60%] border border-gray-300 rounded-md px-3 py-2 text-sm focus:outline-blue-500"
    />

    {/* Filter & Actions */}
    <div className="flex flex-wrap sm:flex-nowrap items-center gap-3">
      {/* Sort */}
      <select className="border border-gray-300 rounded-md px-3 py-2 text-sm focus:outline-blue-500 w-full sm:w-auto">
      ...
      <div className="relative w-full sm:w-auto">
        <button
          ...
          className="border-blue-600 border text-black px-4 py-2 rounded-md text-sm flex items-center justify-between sm:justify-center gap-2 w-full sm:w-auto"
        >
        ...
        {showDropdown && selectedProducts.length > 0 && (
          <div className="absolute right-0 top-full mt-1 w-full sm:w-56 bg-white border border-gray-200 rounded-md shadow-lg z-10">
            <button
  ...
  <p className="text-sm font-medium mb-2">Products (2213 total, showing 50)</p>

  {/* Table (scrollable on small) */}
      ...
      <tbody className="text-sm text-gray-700">
        {products.map((p, i) => (
          ...
          >
            ...
            <td className="p-3 text-blue-600 cursor-pointer">{p.category}</td>
