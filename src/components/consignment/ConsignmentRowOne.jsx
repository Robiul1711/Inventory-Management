            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 bg-[#F4F7FF] gap-6">
                ...
                <div className=" rounded-lg shadow p-6">
                    <div className="flex items-center gap-2 mb-6 ">
                        ...
                        <h2 className="text-xl text-black font-bold">Dashboard Summary</h2>
                    </div>
                ...
                <div className="bg-white rounded-lg shadow p-6">
                    ...
                    <div className="space-y-3">
                        {rightDashboardData.map((item) => (
                            <div
                                key={item.id}
                                className={`p-4 rounded-lg border border-gray-200 flex items-center justify-between ${item.clickable ? 'cursor-pointer hover:bg-gray-50' : ''
...
export default ConsignmentRowOne